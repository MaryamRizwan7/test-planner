// src/pages/GuidelinesBachelors.jsx
import React from "react";
import { useNavigate } from "react-router-dom";
import "bootstrap-icons/font/bootstrap-icons.css";
import "../index.css";

function BachelorsGuidelines() {
  ...
  const bodyStyle = {
    ...
    fontSize: "1rem",
    lineHeight: "1.6",
    color: "#ddd", // softer white for body
  };
  ...
  return (
    <div className="container my-5 p-4 rounded custom-bg shadow-lg" style={{ maxWidth: "900px" }}>
      ...
      <h1 className="text-center mb-4 fw-bold" style={{ fontFamily: '"Packy Great", sans-serif', color: "white" }}>
        BACHELOR'S SCHEDULING GUIDE
      </h1>
      <p style={bodyStyle}>
        Before entering data, carefully review the guidelines. Verify that all files are complete, student numbers are accurate, and shift timings are properly defined. This ensures a seamless scheduling process, with every student, venue, and invigilator correctly assigned.
      </p>
      ...
      <div className="card mb-3 p-3 shadow-sm" style={cardStyle(cardColors[0].bg, cardColors[0].glow)}>
        ...
        <div id="blocksSection" className="collapse show card-body" style={bodyStyle}>
          ...
          <ul>
            <li><strong>Department</strong> – Name of the department</li>
      ...
      <div className="card mb-3 p-3 shadow-sm" style={cardStyle(cardColors[2].bg, cardColors[2].glow)}>
        <div className="card-header d-flex align-items-center" 
             ...
             style={headerStyle}>
          <i className="bi bi-people-fill me-2"></i> Number of Students
        </div>
        <div id="studentsSection" className="collapse show card-body" style={bodyStyle}>
          <p>
            Enter the <strong>total number of students manually</strong> on the next page.
          </p>
          <blockquote className="blockquote" style={{ color: "#0ff" }}>
      ...
      <div className="d-grid mt-4">
        <button className="btn neon-btn btn-lg" onClick={() => navigate("/bachelors")}>
          Proceed to Bachelor's Form
        </button>
      </div>
    </div>
  );
...
export default BachelorsGuidelines;
